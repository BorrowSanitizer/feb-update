...
RUNS=100
WARMUP=10
MFLAGS="-Zmiri-deterministic-concurrency -Zmiri-disable-validation -Zmiri-disable-alignment-check -Zmiri-disable-data-race-detector -Zmiri-tree-borrows -Zmiri-ignore-leaks -Zmiri-provenance-gc=0"
